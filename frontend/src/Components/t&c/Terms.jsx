  ...
  return (
    <div className="p-8 dark:bg-gray-950 bg-base-100 dark:text-gray-50 text-gray-900">
      <>
        ...
        <h3 className="py-4 text-2xl">Hyperlinking to our Content</h3>
        <p>
        ...
        <h3 className="py-4 text-2xl">iFrames</h3>
        <p>
          Without prior approval and written permission, you may not create
          frames around our Webpages that alter in any way the visual
          presentation or appearance of our Website.
        </p>
        <h3 className="py-4 text-2xl">Content Liability</h3>
        <p>
        ...
        <h3 className="py-4 text-2xl">Your Privacy</h3>
        <p>Please read Privacy Policy</p>
        <h3 className="py-4 text-2xl">Reservation of Rights</h3>
        <p>
        ...
        <h3 className="py-4 text-2xl">Removal of links from our website</h3>
        <p>
        ...
        <h3 className="py-4 text-2xl">Disclaimer</h3>
        <p>
