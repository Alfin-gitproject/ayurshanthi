      ...
      <div class=" w-full flex flex-col justify-center items-center mx-auto">
        ...
        <div class="modal-body">
          ...
          <textarea
            name="review"
            id="review"
            class="border border-gray-300 text-gray-800 dark:text-gray-200 rounded-lg mt-4 p-2 w-full"
          ...
          <button
            id="new_review_btn"
            class="bg-emerald-500 text-white rounded-lg w-full my-4 py-2 px-4 "
