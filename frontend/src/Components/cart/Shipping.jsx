    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center bg-base-100 dark:bg-gray-900">
        <form className=" w-full sm:w-3/4 p-6 sm:py-12" onSubmit={submiHandler}>
            ...
            <div className="relative z-0 w-full mb-5 group flex gap-4">
              ...
              <div className="relative w-full">
                ...
                <label
                  ...
                  className={`peer-focus:font-medium absolute text-lg px-2 left-3 focus:left-0 text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-2/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 bg-base-100 dark:bg-gray-900 peer-placeholder-shown:scale-200 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 ${
          ...
          <button
            type="submit"
            className="text-white bg-emerald-600 hover:bg-emerald-700 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-emerald-500 dark:hover:bg-emerald-600 dark:focus:ring-emerald-800"
          >
            Submit
          </button>
        </form>
