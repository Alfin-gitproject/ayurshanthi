    ...
    <div className=" !bg-gray-100">
      ...
      >
        ...
        <motion.p
          ...
          variants={item}
        >
          Welcome to inHerbz Health Care, your gateway to timeless healing
          wisdom. Based in Cochin, Kerala, India, we pioneer modernizing
          traditional Indian medicine. Led by Dr. Lukman M.A., our team crafts
          unique, safe herbal formulations adhering to GMP standards. Explore
          our high-quality products, blending ancient knowledge with
          cutting-edge research for your wellness journey.
        </motion.p>
