...
const Mission = () => {
 ...
 return (
  ...
  className="text-center block relative z-20 mx-auto pt-8"
>
  <div className="rounded-lg p-6 mx-4 md:mx-auto max-w-5xl">
    <motion.h1
      variants={item}
      className="text-4xl font-light my-2 text-gray-900 font-medium"
    >
      Our Commitment
    </motion.h1>
    <motion.p
      variants={item}
      className="text-xl w-full md:w-full mx-auto font-light p-3 text-gray-800 font-calibri"
    >
