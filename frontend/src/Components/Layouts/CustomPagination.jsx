...
const CustomPagination = ({ resPerPage, filteredProductsCount, currentPage, onPageChange }) => {
  ...
  return (
    <div
      className="flex justify-center items-center gap-0.5 sm:gap-1 md:gap-2 py-2 sm:py-3 md:py-4 flex-wrap"
      role="navigation"
    ...
    >
      ...
      <button
        ...
        className={`px-1.5 sm:px-2 md:px-3 py-0.5 sm:py-1 rounded-md text-xs sm:text-sm transition-colors ${
          currentPage === 1
