      ...
      <footer className="footer p-10 max-w-screen-xl mx-auto text-gray-200 font-calibri">
        <aside>
          ...
          <div className="flex gap-4 flex-wrap -ml-3 mt-3">
            ...
            <a
              href="https://www.instagram.com/inherbzwellness/"
              target="blank"
            >
        ...
        <nav>
          ...
          <a href="tel:+91 7034035102" className="link link-hover">
            <span>
              <i className="fa-solid fa-phone me-1"></i>+91 7034035102
            </span>
          </a>
          <a href="mailto:Info@ayurshoppee.com" className="link link-hover">
            <span>
              <i className="fa-solid fa-envelope me-1"></i>Info@ayurshoppee.com
            </span>
          </a>
        </nav>
      </footer>
